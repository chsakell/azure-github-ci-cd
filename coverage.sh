...
dotnet test -f netcoreapp1.1 $DOTNET_TEST_ARGS azure-github-ci-cd.Tests/azure-github-ci-cd.Tests.csproj

echo "Calculating coverage with OpenCover"
$OPENCOVER \
  -target:"c:\Program Files\dotnet\dotnet.exe" \
  -targetargs:"test -f netcoreapp1.1 $DOTNET_TEST_ARGS azure-github-ci-cd.Tests/azure-github-ci-cd.Tests.csproj" \
  -mergeoutput \
  -hideskipped:File \
  -output:$coverage/coverage.xml \
  -oldStyle \
  -filter:"+[azure-github-ci-cd*]* -[azure-github-ci-cd.*Tests*]*" \
